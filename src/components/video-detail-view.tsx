...
import { ArrowLeft, Clock, Save, Play } from "lucide-react"
import { Video, Note } from "@/types"
import { VideoPlayer, VideoPlayerRef } from "@/components/video-player"
import { Button } from "@/components/ui/button"
import { Textarea } from "@/components/ui/textarea"
import { addNote, getLibrary } from "@/lib/storage"
    ...
    <div className="flex flex-col h-full gap-4 p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-4 min-h-0">
          <div className="bg-card border rounded-lg p-4 space-y-4 shrink-0">
          ...
          <div className="flex-1 bg-muted/20 rounded-lg border flex flex-col min-h-0">
